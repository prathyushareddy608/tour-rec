...
class MonumentTickets(models.Model):
    ...
    count_children=models.IntegerField()  # Children below 12 years
    count_abroad=models.IntegerField()
    count_senior=models.IntegerField(default=0)  # Senior citizens 60+ years
    ...
    price_senior=models.DecimalField(decimal_places=1,max_digits=7,default=0)  # Senior citizen pricing
    ...
    aadhar_card_file=models.FileField(upload_to='aadhar_uploads/', blank=True, null=True)
